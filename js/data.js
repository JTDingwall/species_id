...
const SPECIES_DATA = [
  ...
  {
    id: 226,
    commonName: "Red Feather Alga",
    latinName: "Ptilota filicina",
    phylum: "Rhodophyta",
    class: "Florideophyceae",
    order: "Ceramiales",
    habitat: "Low intertidal",
    description: "Delicate, feathery red alga with fine, regularly branched fronds. Deep red to pink color. Grows on rocks in shaded tidepools and kelp holdfasts.",
    identificationTips: ["Fine, feather-like branching pattern with a flat, two-dimensional frond", "Deep red to pink; grows in dense, soft clumps", "Found on rocks and attached to other algae in shaded areas"],
    imageUrl: "images/species-226.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#cc3355"
  },
  {
    id: 227,
    commonName: "Encrusting Coralline Alga",
    latinName: "Lithophyllum impressum",
    phylum: "Rhodophyta",
    class: "Florideophyceae",
    order: "Corallinales",
    habitat: "Low intertidal",
    description: "Thick, pinkish-grey encrusting coralline alga forming hard, smooth crusts on rocks. Deposits calcium carbonate, creating rock-like surfaces. Provides settlement habitat for many invertebrates.",
    identificationTips: ["Hard, rock-like pinkish to grey crust on rocks", "Smooth surface unlike bumpy Lithothamnion species", "Forms extensive sheets in the low intertidal and shallow subtidal"],
    imageUrl: "images/species-227.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#cc88aa"
  },
  {
    ...
    latinName: "Leathesia marina",
    phylum: "Ochrophyta",
    class: "Phaeophyceae",
    order: "Ectocarpales",
    habitat: "Mid intertidal",
    description: "Small, golden-brown alga forming soft, brain-like or cauliflower-shaped hollow spheres on rocks. Feels spongy and rubbery. Common on mid-intertidal rocks and other algae.",
    identificationTips: ["Small, brain-like or cauliflower-shaped, golden-brown hollow balls", "Soft, spongy, rubbery texture; squeezable", "Often on rocks and epiphytic on other algae like Corallina"],
    imageUrl: "images/species-228.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#bb9933"
  },
  {
    id: 229,
    commonName: "Sea Fern",
    latinName: "Ptilota densa",
    phylum: "Rhodophyta",
    class: "Florideophyceae",
    order: "Ceramiales",
    habitat: "Low intertidal",
    description: "Fine, densely branched red alga resembling a miniature fern. Bright red to burgundy. Grows in small, soft tufts on rocks and epiphytic on kelp stipes.",
    identificationTips: ["Dense, fern-like branching with very fine, hair-like tips", "Bright red to deep burgundy coloration", "Tufted growth form; soft to the touch"],
    imageUrl: "images/species-229.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#aa2244"
  },
  {
    id: 230,
    commonName: "Brown Scouring Pad Alga",
    latinName: "Endocladia muricata",
    phylum: "Rhodophyta",
    class: "Florideophyceae",
    order: "Gigartinales",
    habitat: "High to mid intertidal",
    description: "Small, dark reddish-brown tufted alga with wiry, rough branches. Feels like a scouring pad when dry. Very common on high-intertidal rocks, often forming dark patches.",
    identificationTips: ["Dark reddish-brown to almost black, wiry, rough branches", "Forms small (2-5 cm) dense tufts on high-intertidal rocks", "Feels rough and scratchy like a scouring pad"],
    imageUrl: "images/species-230.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#553322"
  },
  {
    id: 231,
    commonName: "Kelp Perch",
    latinName: "Brachyistius frenatus",
    phylum: "Chordata",
    class: "Actinopterygii",
    order: "Perciformes",
    habitat: "Subtidal",
    description: "Small, copper-colored surfperch (up to 20 cm) with a deep, compressed body. Feeds on small crustaceans picked from kelp fronds. Often in small groups around kelp beds.",
    identificationTips: ["Copper to bronze body with a deep, compressed shape", "Small mouth with slightly protruding lips", "Swims among kelp fronds, picking at small invertebrates"],
    imageUrl: "images/species-231.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#cc8844"
  },
  {
    id: 232,
    commonName: "Striped Surfperch",
    latinName: "Embiotoca lateralis",
    phylum: "Chordata",
    class: "Actinopterygii",
    order: "Perciformes",
    habitat: "Subtidal",
    description: "Colorful surfperch (up to 38 cm) with bright blue horizontal stripes on a coppery-orange body. Feeds on small invertebrates. Common around rocky reefs and kelp forests.",
    identificationTips: ["Bright iridescent blue horizontal stripes on orange-copper body", "Deep, compressed body; large eyes", "Found near rocky reefs, docks, and kelp beds"],
    imageUrl: "images/species-232.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#3388cc"
  },
  {
    ...
    order: "Gadiformes",
    habitat: "Subtidal",
    description: "Slender cod relative (up to 90 cm) with large eyes and a small chin barbel. Olive to brown with silvery sides. One of the most commercially important fish in the North Pacific.",
    identificationTips: ["Large eyes relative to head; small barbel (whisker) on chin", "Three separate dorsal fins and two anal fins", "Silvery sides with olive to brown back; forms large schools"],
    imageUrl: "images/species-233.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#779966"
  },
  {
    ...
    latinName: "Gadus macrocephalus",
    phylum: "Chordata",
    class: "Actinopterygii",
    order: "Gadiformes",
    habitat: "Subtidal",
    description: "Heavy-bodied cod (up to 1 m) with a mottled brown-grey body, a pale lateral line, and a prominent chin barbel. Important commercial and subsistence fishery species.",
    identificationTips: ["Heavy, deep body with mottled brown and grey coloration", "Prominent chin barbel; pale lateral line", "Three dorsal fins; large head with wide mouth"],
    imageUrl: "images/species-234.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#8b7d6b"
  },
  {
    ...
    order: "Salmoniformes",
    habitat: "Subtidal",
    description: "The largest Pacific salmon (up to 1.5 m, 60 kg). Metallic blue-green back with silvery sides. Black spots on back and both lobes of tail. Black mouth with black gums. Keystone species.",
    identificationTips: ["Large size; metallic blue-green back, silvery sides", "Black spots on both lobes of the tail fin", "Black mouth and gums (distinguishes from coho)"],
    imageUrl: "images/species-235.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#336699"
  },
  {
    ...
    order: "Salmoniformes",
    habitat: "Subtidal",
    description: "Bright silver salmon (up to 1 m) with metallic blue-green back. White gums with grey tongue. Spots only on upper lobe of tail. Bright red spawning coloration.",
    identificationTips: ["White gums with grey tongue (vs. black gums of chinook)", "Spots only on upper tail lobe", "Bright silver with metallic blue-green back; spawning males turn bright red"],
    imageUrl: "images/species-236.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#4488bb"
  },
  {
    ...
    order: "Pleuronectiformes",
    habitat: "Subtidal",
    description: "The largest flatfish in the world (up to 2.5 m, 300 kg). Both eyes on right side. Mottled brown to dark brown. Diamond-shaped body. Highly prized commercial and recreational species.",
    identificationTips: ["Very large, diamond-shaped flatfish with both eyes on right side", "Mottled brown to dark gray on eyed side; white on blind side", "Large, toothy mouth; can weigh hundreds of pounds"],
    imageUrl: "images/species-237.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#5a4a3a"
  },
  {
    ...
    latinName: "Atheresthes stomias",
    phylum: "Chordata",
    class: "Actinopterygii",
    order: "Pleuronectiformes",
    habitat: "Subtidal",
    description: "Right-eyed flatfish (up to 80 cm) with large mouth and sharp, arrow-shaped teeth. Brown to olive above. Very abundant in deep shelf waters. Soft flesh limits commercial value.",
    identificationTips: ["Right-eyed flatfish with large mouth extending past midline", "Sharp, arrow-like teeth in both jaws", "Uniform brown-olive; very abundant in trawl catches"],
    imageUrl: "images/species-238.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#6b5e4a"
  },
  {
    id: 239,
    commonName: "Intertidal Sculpin",
    latinName: "Oligocottus rubellio",
    phylum: "Chordata",
    class: "Actinopterygii",
    order: "Scorpaeniformes",
    habitat: "Mid intertidal",
    description: "Small, highly camouflaged sculpin (up to 7 cm) with mottled reddish-brown to pinkish coloration. Often found in tidepools and under rocks. Can survive extended periods out of water.",
    identificationTips: ["Small size with mottled reddish-brown to pinkish coloration", "Large head and mouth; large pectoral fins", "Perfectly camouflaged in rocky tidepools; darts quickly"],
    imageUrl: "images/species-239.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#996655"
  },
  {
    ...
    order: "Salmoniformes",
    habitat: "Subtidal",
    description: "Smallest Pacific salmon (up to 75 cm). Large black oval spots on back and tail. Males develop pronounced hump during spawning (hence 'humpback salmon'). Most abundant salmon species.",
    identificationTips: ["Smallest of the Pacific salmon", "Large oval black spots on back and entire tail", "Spawning males have extremely pronounced humped back"],
    imageUrl: "images/species-240.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#cc7799"
  },
  {
    ...
    order: "Salmoniformes",
    habitat: "Subtidal",
    description: "Medium salmon (up to 1 m) with no spots on back or tail. Metallic blue-green back with silvery sides. Calico vertical bars on spawning adults. Widest geographic range of any Pacific salmon.",
    identificationTips: ["No spots on back or tail (unlike chinook, coho, and pink)", "Silvery with metallic blue-green sheen at sea", "Spawning adults develop distinctive calico vertical bars"],
    imageUrl: "images/species-241.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#558866"
  },
  {
    id: 242,
    commonName: "Heart Crab",
    latinName: "Phyllolithodes papillosus",
    phylum: "Arthropoda",
    class: "Malacostraca",
    order: "Decapoda",
    habitat: "Subtidal",
    description: "Unusual, heavily armored crab with a heart-shaped carapace covered in prominent knobby spines and bumps. Reddish-brown. Found on rocky reefs and in crevices.",
    identificationTips: ["Heart-shaped carapace covered in prominent knobby spines", "Reddish-brown with thick, bumpy legs", "Looks like a heavily armored, heart-shaped rock"],
    imageUrl: "images/species-242.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#993333"
  },
  {
    ...
    latinName: "Munida quadrispina",
    phylum: "Arthropoda",
    class: "Malacostraca",
    order: "Decapoda",
    habitat: "Subtidal",
    description: "Small, reddish-orange galatheid crab (not a true lobster). Long claws and a folded-under tail. Very abundant in deep reef habitats, forming dense aggregations on rocks and sponges.",
    identificationTips: ["Small, bright reddish-orange body with very long claws", "Tail tucked under body like a true crab", "Forms massive aggregations on rocky reefs and sponges"],
    imageUrl: "images/species-243.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#ee6633"
  },
  {
    id: 244,
    commonName: "Polyonyx Porcelain Crab",
    latinName: "Polyonyx quadriunguiculatus",
    phylum: "Arthropoda",
    class: "Malacostraca",
    order: "Decapoda",
    habitat: "Subtidal",
    description: "A commensal porcelain crab living inside the tubes of large polychaete worms (especially Chaetopterus). Flat, greyish-white body with small claws. Rarely seen outside its host tube.",
    identificationTips: ["Flat, greyish-white body; lives inside polychaete worm tubes", "Small, equal-sized claws; filter-feeds with feathery mouthparts", "Commensal relationship with tube-dwelling worms"],
    imageUrl: "images/species-244.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#ccc8b8"
  },
  {
    id: 245,
    commonName: "Pink Barnacle",
    latinName: "Tetraclita rubescens",
    phylum: "Arthropoda",
    class: "Thecostraca",
    order: "Balanomorpha",
    habitat: "Mid intertidal",
    description: "Large, solitary barnacle with distinctive reddish-pink shell plates. The shell is volcano-shaped with prominent ridges and a large diamond-shaped opening.",
    identificationTips: ["Large, solitary barnacle with pink to reddish-purple shell", "Heavy vertical ridges on shell plates; large diamond-shaped opening", "Found on wave-exposed rocks in the mid-intertidal zone"],
    imageUrl: "images/species-245.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#cc6688"
  },
  {
    id: 246,
    commonName: "Kelp Louse",
    latinName: "Pentidotea resecata",
    phylum: "Arthropoda",
    class: "Malacostraca",
    order: "Isopoda",
    habitat: "Subtidal",
    description: "Large, highly camouflaged isopod (up to 5 cm) that perfectly mimics kelp blades. Bright olive-green to brown. Clings to giant kelp and bull kelp fronds, grazing on the tissue.",
    identificationTips: ["Large, flat, leaf-like isopod with color matching kelp", "Olive-green to brown; elongated oval body", "Found clinging tightly to kelp fronds; blends in perfectly"],
    imageUrl: "images/species-246.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#5a8a3a"
  },
  {
    id: 247,
    commonName: "Lined Shore Crab",
    latinName: "Pachygrapsus crassipes",
    phylum: "Arthropoda",
    class: "Malacostraca",
    order: "Decapoda",
    habitat: "High intertidal",
    description: "Fast-moving crab with dark body and bright green legs. Has transverse lines on the carapace. Very agile climber found on rocks and jetties in the high intertidal.",
    identificationTips: ["Dark body with bright green legs; transverse ridges on carapace", "Extremely fast and agile; climbs vertical rock faces", "Found high in the intertidal on rocks and jetties"],
    imageUrl: "images/species-247.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#2a4a2a"
  },
  {
    id: 248,
    commonName: "Pea Crab",
    latinName: "Fabia subquadrata",
    phylum: "Arthropoda",
    class: "Malacostraca",
    order: "Decapoda",
    habitat: "Subtidal",
    description: "Tiny, soft-bodied crab (carapace up to 2 cm) that lives as a commensal inside mussels and clams. Males are free-living while females live permanently inside the host.",
    identificationTips: ["Extremely small (pea-sized), soft, rounded body", "Females found inside mussels and clams as commensals", "Translucent white to pale pink; tiny claws"],
    imageUrl: "images/species-248.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#eecccc"
  },
  {
    id: 249,
    commonName: "Island Kelp Crab",
    latinName: "Pugettia richii",
    phylum: "Arthropoda",
    class: "Malacostraca",
    order: "Decapoda",
    habitat: "Subtidal",
    description: "Slender kelp crab with two prominent rostral horns and spiny legs. Decorates carapace with bits of algae and bryozoans. Reddish-brown to olive. Common in kelp beds.",
    identificationTips: ["Two prominent, widely spaced rostral horns", "Decorates itself with algae, hydroids, and bryozoans", "Slender body and legs; reddish-brown to olive"],
    imageUrl: "images/species-249.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#8c5a3a"
  },
  {
    ...
    latinName: "Pleuroncodes planipes",
    phylum: "Arthropoda",
    class: "Malacostraca",
    order: "Decapoda",
    habitat: "Subtidal",
    description: "Small, bright red squat lobster-like crab that occasionally swarms in massive numbers along the coast during warm-water events. Important food source for tuna, seabirds, and whales.",
    identificationTips: ["Bright red to orange-red; squat lobster-like body shape", "Occasionally swarms in massive numbers during El Niño events", "Long claws; folds tail under body"],
    imageUrl: "images/species-250.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#ff4433"
  },
  {
    id: 251,
    commonName: "Graceful Decorator Crab",
    latinName: "Oregonia bifurca",
    phylum: "Arthropoda",
    class: "Malacostraca",
    order: "Decapoda",
    habitat: "Subtidal",
    description: "Very long-legged spider crab with an elongated, pear-shaped carapace. Densely covered in attached sponges, hydroids, and algae for camouflage. Two long, diverging rostral spines.",
    identificationTips: ["Extremely long, slender legs; pear-shaped carapace", "Densely decorated with sponges and hydroids", "Two very long, diverging rostral spines"],
    imageUrl: "images/species-251.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#a08060"
  },
  {
    ...
    order: "Ceriantharia",
    habitat: "Subtidal",
    description: "Beautiful cerianthid anemone with two distinct rings of tentacles. Lives in a soft, fibrous tube buried in soft sediment. Outer tentacles are long and tapering; inner tentacles are short. Bioluminescent.",
    identificationTips: ["Two distinct rings of tentacles: long outer and short inner", "Tentacles often banded in brown, cream, or purple", "Lives in a soft tube buried in sand or mud"],
    imageUrl: "images/species-252.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#8b5e3c"
  },
  {
    id: 253,
    commonName: "Sea Whip",
    latinName: "Swiftia pacifica",
    phylum: "Cnidaria",
    class: "Anthozoa",
    order: "Alcyonacea",
    habitat: "Subtidal",
    description: "Colonial octocoral forming tall, whip-like branches of bright red to orange-red polyps. Grows on rocky reefs. Polyps extend along the branch, giving a fuzzy appearance when feeding.",
    identificationTips: ["Bright red to orange-red, tall, whip-like branching colonies", "Small white polyps extending from the branches when feeding", "Found on vertical rock walls in areas with current"],
    imageUrl: "images/species-253.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#ff4422"
  },
  {
    id: 254,
    commonName: "Purple-ringed Top Snail",
    latinName: "Calliostoma annulatum",
    phylum: "Mollusca",
    class: "Gastropoda",
    order: "Trochida",
    habitat: "Low intertidal",
    description: "Beautifully colored snail with a golden shell adorned with brilliant purple rings. The shell is tall and conical. Grazes on hydroids and bryozoans on kelp and rocks.",
    identificationTips: ["Golden shell with distinctive bright purple bands around each whorl", "Tall, conical shell shape; pearly interior", "Grazes on hydroids and bryozoans on kelp fronds"],
    imageUrl: "images/species-254.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#cc9933"
  },
  {
    id: 255,
    commonName: "Purple Jellyfish",
    latinName: "Pelagia colorata",
    phylum: "Cnidaria",
    class: "Scyphozoa",
    order: "Semaeostomeae",
    habitat: "Subtidal",
    description: "Small, brilliantly purple jellyfish (bell up to 10 cm) with 8 marginal tentacles and 4 frilly oral arms. Strong sting for its size. Often swarms in summer and fall near shore.",
    identificationTips: ["Brilliant purple bell with 8 marginal tentacles", "4 frilly, purple oral arms extending from center", "Strong stinger; forms swarms near shore in summer/fall"],
    imageUrl: "images/species-255.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#8833cc"
  },
  {
    id: 256,
    commonName: "Aggregate Green Anemone",
    latinName: "Anthopleura sola",
    phylum: "Cnidaria",
    class: "Anthozoa",
    order: "Actiniaria",
    habitat: "Mid intertidal",
    description: "Larger solitary relative of the aggregating anemone, with a green column and pink-tipped tentacles. Often found alone in tidepools and crevices. Distinct bright green oral disk.",
    identificationTips: ["Solitary (not colonial) anemone with green column", "Pink to lavender-tipped tentacles around bright green oral disk", "Larger than aggregating anemone; found alone in tidepools"],
    imageUrl: "images/species-256.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#44aa44"
  },
  {
    id: 257,
    commonName: "Crimson Anemone",
    latinName: "Cribrinopsis fernaldi",
    phylum: "Cnidaria",
    class: "Anthozoa",
    order: "Actiniaria",
    habitat: "Low intertidal",
    description: "Strikingly colored anemone with a crimson to deep red column and white-banded tentacles. Found in crevices and under rocks in the low intertidal. Up to 15 cm tall.",
    identificationTips: ["Rich crimson to deep red column", "White-banded tentacles radiating from the oral disk", "Found under rocks and in shaded crevices"],
    imageUrl: "images/species-257.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#cc2244"
  },
  {
    ...
    latinName: "Metridium farcimen",
    phylum: "Cnidaria",
    class: "Anthozoa",
    order: "Actiniaria",
    habitat: "Subtidal",
    description: "Tall, graceful anemone (up to 1 m!) with a long, smooth column and a fluffy crown of fine, white tentacles. Common on dock pilings and subtidal rocks. One of the tallest anemones.",
    identificationTips: ["Extremely tall, smooth column topped with fluffy crown of fine white tentacles", "Up to 1 m in height on dock pilings", "Pure white to cream; looks like a fluffy cauliflower on a stalk"],
    imageUrl: "images/species-258.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#f8f4e8"
  },
  {
    id: 259,
    commonName: "Arctic Sun Jelly",
    latinName: "Aglantha digitale",
    phylum: "Cnidaria",
    class: "Hydrozoa",
    order: "Trachymedusae",
    habitat: "Subtidal",
    description: "Tiny, transparent hydrozoan jellyfish (bell up to 4 cm) with a tall, conical bell and 8 long, trailing tentacles. Abundant in spring and summer plankton. Does not have a polyp stage.",
    identificationTips: ["Tiny, nearly transparent, tall conical bell", "8 long, thread-like trailing tentacles", "Very abundant in spring plankton; no attached polyp stage"],
    imageUrl: "images/species-259.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#c8e0f0"
  },
  {
    id: 260,
    commonName: "Rose Sea Star",
    latinName: "Crossaster papposus",
    phylum: "Echinodermata",
    class: "Asteroidea",
    order: "Valvatida",
    habitat: "Subtidal",
    description: "Beautiful, large sea star with 8-16 arms and a velvety surface covered in concentric rings of red, pink, and cream. Looks like a rose. Voracious predator of other sea stars and bivalves.",
    identificationTips: ["8-16 arms with concentric rings of red, pink, and cream", "Velvety surface texture; beautiful rose-like appearance", "Predatory; feeds on other sea stars and bivalves"],
    imageUrl: "images/species-260.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#cc4466"
  },
  {
    id: 261,
    commonName: "Spiny Red Sea Star",
    latinName: "Hippasteria spinosa",
    phylum: "Echinodermata",
    class: "Asteroidea",
    order: "Valvatida",
    habitat: "Subtidal",
    description: "Large, robust sea star with 5 short arms and a thick, armored body covered in prominent blunt spines. Bright red-orange. Feeds on deep-water corals and sponges.",
    identificationTips: ["5 short, thick arms with blunt, prominent spines on top", "Bright red-orange to vermilion coloration", "Thick, heavily armored body; feeds on corals and sponges"],
    imageUrl: "images/species-261.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#ee5533"
  },
  {
    id: 262,
    commonName: "Sea Cucumber (Orange)",
    latinName: "Cucumaria pallida",
    phylum: "Echinodermata",
    class: "Holothuroidea",
    order: "Dendrochirotida",
    habitat: "Low intertidal",
    description: "Small, pale orange to cream sea cucumber with 10 branching feeding tentacles. Covered in tube feet. Found under rocks and in crevices. Retracts when disturbed.",
    identificationTips: ["Pale orange to cream body with 10 branching tentacles", "Five rows of tube feet running along the body", "Found under rocks; contracts into a tight ball when disturbed"],
    imageUrl: "images/species-262.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#ee9944"
  },
  {
    id: 263,
    commonName: "Burrowing Brittle Star",
    latinName: "Amphiodia urtica",
    phylum: "Echinodermata",
    class: "Ophiuroidea",
    order: "Ophiurida",
    habitat: "Subtidal",
    description: "Tiny brittle star (disk up to 5 mm) with very long, slender arms. Lives buried in sand, extending only arm tips to feed. Extremely abundant in soft sediments.",
    identificationTips: ["Extremely tiny central disk with very long, slender arms", "Lives buried in soft sediment with arm tips exposed", "Very abundant but rarely seen whole"],
    imageUrl: "images/species-263.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#d4c8b0"
  },
  {
    id: 264,
    commonName: "Sand-rose Anemone",
    latinName: "Urticina columbiana",
    phylum: "Cnidaria",
    class: "Anthozoa",
    order: "Actiniaria",
    habitat: "Subtidal",
    description: "Large, beautiful anemone with a column covered in pale, sand-colored tubercles and a wide oral disk with numerous short tentacles. Red, orange, or white. Attached to buried rocks.",
    identificationTips: ["Column covered in prominent pale, sand-colored tubercles", "Wide oral disk with short, stubby tentacles", "Red, orange, or white; attached to rocks protruding from sand"],
    imageUrl: "images/species-264.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#ee7733"
  },
  {
    ...
    latinName: "Parastichopus parvimensis",
    phylum: "Echinodermata",
    class: "Holothuroidea",
    order: "Aspidochirotida",
    habitat: "Subtidal",
    description: "Medium sea cucumber (up to 25 cm) with a brown to reddish-brown body covered in large, dark-tipped fleshy papillae. Soft-bodied detritivore.",
    identificationTips: ["Brown to reddish-brown body with prominent dark-tipped warty bumps", "Large conical papillae in rows along the body", "Soft, flexible body; common in sandy areas"],
    imageUrl: "images/species-265.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#8b5a3a"
  },
  {
    id: 266,
    commonName: "Cookie Star",
    latinName: "Ceramaster patagonicus",
    phylum: "Echinodermata",
    class: "Asteroidea",
    order: "Valvatida",
    habitat: "Subtidal",
    description: "Small, perfectly pentagonal sea star with a thick, dome-shaped body and very short arms. Looks like a cookie or cushion. Orange to red. Common on deep reefs but sometimes found in low intertidal.",
    identificationTips: ["Perfectly pentagonal shape with almost no arms — looks like a cookie", "Thick, dome-shaped body; orange to red", "Smooth, firm texture; found on rocky reefs"],
    imageUrl: "images/species-266.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#ff8844"
  },
  {
    ...
    latinName: "Entosphenus tridentatus",
    phylum: "Chordata",
    class: "Hyperoartia",
    order: "Petromyzontiformes",
    habitat: "Subtidal",
    description: "Eel-like jawless fish with a round, sucker-like mouth filled with sharp teeth. Adults are parasitic on other fish. Important traditional food and ceremonial species for Indigenous peoples.",
    identificationTips: ["Eel-like body with no jaws; round sucker mouth with teeth", "Seven round gill openings on each side (not slits)", "Dark blue-grey to brown; adults parasitic on fish"],
    imageUrl: "images/species-267.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#445566"
  },
  {
    ...
    latinName: "Hydrolagus colliei",
    phylum: "Chordata",
    class: "Chondrichthyes",
    order: "Chimaeriformes",
    habitat: "Subtidal",
    description: "Bizarre-looking deep-water relative of sharks with a large, rabbit-like head, long tapering tail, and a venomous spine in front of the dorsal fin. Silvery with white spots.",
    identificationTips: ["Large rabbit-like head with big green eyes; long tapering tail", "Silvery body with scattered white spots", "Venomous spine in front of first dorsal fin"],
    imageUrl: "images/species-268.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#8899aa"
  },
  {
    id: 269,
    commonName: "Big Skate",
    latinName: "Raja binoculata",
    phylum: "Chordata",
    class: "Chondrichthyes",
    order: "Rajiformes",
    habitat: "Subtidal",
    description: "Large skate (up to 2.4 m) with a diamond-shaped body and two large dark spots (ocelli) on the pectoral fins. Grey to brown above, white below. Lays large egg cases ('mermaid's purses').",
    identificationTips: ["Diamond-shaped body with two large dark eye-spots on wings", "Grey to brown above with scattered dark spots; white below", "Very large; lays distinctive rectangular egg cases on beaches"],
    imageUrl: "images/species-269.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#7a7a6a"
  },
  {
    ...
    order: "Osmeriformes",
    habitat: "Subtidal",
    description: "Small, slender, silvery fish (up to 15 cm) with long pectoral fins reaching past the dorsal fin. Anadromous, spawning in freshwater. Important forage fish. Has a cucumber-like smell when fresh.",
    identificationTips: ["Very long pectoral fins extending past the dorsal fin base", "Small, slender, silvery body with large eyes", "Smells distinctly like cucumber when fresh"],
    imageUrl: "images/species-270.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#aabbcc"
  },
  {
    ...
    latinName: "Hypomesus pretiosus",
    phylum: "Chordata",
    class: "Actinopterygii",
    order: "Osmeriformes",
    habitat: "Subtidal",
    description: "Small, silvery forage fish (up to 25 cm) that spawns on sandy beaches at high tide. Short pectoral fins. Important prey for salmon, seabirds, and marine mammals.",
    identificationTips: ["Small, slender, silvery fish with bright silver lateral band", "Short pectoral fins (unlike longfin smelt)", "Spawns in the swash zone on sandy beaches"],
    imageUrl: "images/species-271.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#99aabb"
  },
  {
    id: 272,
    commonName: "Eulachon",
    latinName: "Thaleichthys pacificus",
    phylum: "Chordata",
    class: "Actinopterygii",
    order: "Osmeriformes",
    habitat: "Subtidal",
    description: "Small, oily smelt (up to 30 cm) of immense cultural and ecological importance. Spawns in coastal rivers in spring. Historically rendered for oil ('candlefish' — so oily it can be dried and burned like a candle). Critical food for marine mammals, birds, and fish.",
    identificationTips: ["Small, silvery smelt with very oily flesh; pale lateral line", "No distinct striations on gill cover (unlike surf smelt)", "Spawning runs turn rivers silver in spring (March-May)"],
    imageUrl: "images/species-272.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#99aabb"
  },
  {
    ...
    latinName: "Raja rhina",
    phylum: "Chordata",
    class: "Chondrichthyes",
    order: "Rajiformes",
    habitat: "Subtidal",
    description: "Large skate (up to 1.8 m) with a long, pointed snout and a diamond-shaped body covered in small thorns. Dark brown to grey. Lays distinctive egg cases. Important benthic predator on crustaceans and fish.",
    identificationTips: ["Long, sharply pointed snout (vs. blunt snout of big skate)", "Diamond-shaped body with scattered small thorns on back", "Dark brown to grey; two small dorsal fins near tail tip"],
    imageUrl: "images/species-273.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#6a5a4a"
  },
  {
    ...
    order: "Balanomorpha",
    habitat: "Subtidal",
    description: "The world's largest barnacle (up to 15 cm diameter, 30 cm height). Volcano-shaped shell with jagged, heavily ridged plates. Found on subtidal rocks and pilings. Filter-feeds with massive fan-like cirri.",
    identificationTips: ["Massive volcano-shaped shell — largest barnacle species globally", "Heavily ridged, jagged grey-white shell plates", "Large opening with feathery cirri visible when feeding"],
    imageUrl: "images/species-274.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#c8c0b8"
  },
  {
    id: 275,
    commonName: "Glassy Sea Squirt",
    latinName: "Ascidia paratropa",
    phylum: "Chordata",
    class: "Ascidiacea",
    order: "Phlebobranchia",
    habitat: "Subtidal",
    description: "Large, solitary tunicate with a transparent, gelatinous outer tunic through which internal organs are visible. Pale green to white. Two long siphons at the top. Attached to rocks and dock pilings.",
    identificationTips: ["Transparent outer tunic — internal organs clearly visible", "Two long, prominent siphons extending from the top", "Pale greenish to white; large (up to 15 cm); solitary form"],
    imageUrl: "images/species-275.jpg",
    imageCredit: "Photo: Wikimedia Commons CC-BY-SA",
    color: "#c8e8d0"
  }
];
